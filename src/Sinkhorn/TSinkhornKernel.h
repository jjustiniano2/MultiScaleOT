...
public:
	...
	void changeLayer(const double *_muX, const double * _muY, int _layerBottom);
...
//		// END DEBUG
	...
	std::vector<TSinkhornKernelGenerator::TCandidate> findKernelLine(int _layerBottom, int a, int mode, double _slack);
